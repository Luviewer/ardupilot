...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Description: Controls motor mixing for multicopters. Not used for Traditional Helicopters. For TriTilt (FRAME_CLASS=7), set FRAME_TYPE=20.
    // @Values: 0:Plus, 1:X, 2:V, 3:H, 4:V-Tail, 5:A-Tail, 10:Y6B, 11:Y6F, 12:BetaFlightX, 13:DJIX, 14:ClockwiseX, 15:I, 18:BetaFlightXReversed, 19:Y4, 20:TriTilt
    // @User: Standard
    // @RebootRequired: True
