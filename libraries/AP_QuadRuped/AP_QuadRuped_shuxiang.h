...
// 对角步态后端实现
class AP_QuadRuped_shuxiang : public AP_QuadRuped_Backend {
public:
    // 构造函数
    AP_QuadRuped_shuxiang(AP_QuadRuped& frontend, AP_QuadRuped::QuadRuped_State& state, AP_AHRS_View& ahrs, AP_Motors& motors);

    // 析构函数
    virtual ~AP_QuadRuped_shuxiang() { }
