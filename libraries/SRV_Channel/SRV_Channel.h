...
public:
    ...
    typedef enum
    {
        ...
        k_rcin16_mapped         = 155,
        k_lift_release          = 156,
        k_legmotor_rf_coxa      = 157,
        k_legmotor_rf_femu      = 158,
        k_legmotor_rf_tibi      = 159,
        k_legmotor_rb_coxa      = 160,
        k_legmotor_rb_femu      = 161,
        k_legmotor_rb_tibi      = 162,
        k_legmotor_lb_coxa      = 163,
        k_legmotor_lb_femu      = 164,
        k_legmotor_lb_tibi      = 165,
        k_legmotor_lf_coxa      = 166,
        k_legmotor_lf_femu      = 167,
        k_legmotor_lf_tibi      = 168,
        k_hexleg_rf_coxa        = 169,
        k_hexleg_rf_femu        = 170,
        k_hexleg_rf_tibi        = 171,
        k_hexleg_rb_coxa        = 172,
        k_hexleg_rb_femu        = 173,
        k_hexleg_rb_tibi        = 174,
        k_hexleg_lb_coxa        = 175,
        k_hexleg_lb_femu        = 176,
        k_hexleg_lb_tibi        = 177,
        k_hexleg_lf_coxa        = 178,
        k_hexleg_lf_femu        = 179,
        k_hexleg_lf_tibi        = 180,
        k_hexleg_rm_coxa        = 181,
        k_hexleg_rm_femu        = 182,
        k_hexleg_rm_tibi        = 183,
        k_hexleg_lm_coxa        = 184,
        k_hexleg_lm_femu        = 185,
        k_hexleg_lm_tibi        = 186,
